...
exportgraphics(f, 'ReplayWM_meas_df.pdf')
...
legend('\DeltaP_{tie,1} residual','\DeltaP_{tie,1} threshold',...
    'Location','northwest')
exportgraphics(f, 'ReplayWM_meas_dptie.pdf')

[DetPerf(10,1:3),DetPerf(10,7:9),DetPerf(10,4:6)] = detectionperformance(...
...
legend('\Deltaf_1 residual','\Deltaf_2 residual',...
    '\Deltaf_1 threshold','\Deltaf_2 threshold','Location','northwest')
exportgraphics(f, 'ReplayWM_cont_df.pdf')
...
legend('\DeltaP_{tie,1} residual','\DeltaP_{tie,1} threshold',...
    'Location','northwest')
exportgraphics(f, 'ReplayWM_cont_dptie.pdf')

[DetPerf(11,1:3),DetPerf(11,7:9),DetPerf(11,4:6)] = detectionperformance(...
    df1_res,df2_res,dPtie1_res,df1_thres,df2_thres,dPtie1_thres,...
    attack_start_k,attack_duration_k);
...
legend('\Deltaf_1 residual','\Deltaf_2 residual',...
    '\Deltaf_1 threshold','\Deltaf_2 threshold','Location','northwest')
exportgraphics(f, 'ReplayWM_both_df.pdf')
...
legend('\DeltaP_{tie,1} residual','\DeltaP_{tie,1} threshold',...
    'Location','northwest')
exportgraphics(f, 'ReplayWM_both_dptie.pdf')

[DetPerf(12,1:3),DetPerf(12,7:9),DetPerf(12,4:6)] = detectionperformance(...
    df1_res,df2_res,dPtie1_res,df1_thres,df2_thres,dPtie1_thres,...
    attack_start_k,attack_duration_k);